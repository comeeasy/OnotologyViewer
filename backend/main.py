...
from routers import classes, config, data_properties, datasets, graphs, individuals, namespaces, object_properties, sparql_editor, reasoning, shacl, rules, datasources
